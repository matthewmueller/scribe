...
require.register("scribe/index.js", function(exports, require, module){
/**
 * Expose scribe
 */
...
require.register("scribe/scribe.js", function(exports, require, module){
/*!
...
modules['plugins_core_patches_empty_when_deleting'] = function emptyEditorWhenDeleting() {
    return function (scribe) {
...
modules['api_command_patch'] = function (scribe) {
...
modules['api_command'] = function (scribe) {
...
modules['api_selection'] = function (scribe) {
    function Selection() {
...
modules['api_simple_command'] = function (api, scribe) {
...
modules['undo_manager'] = function (scribe) {
